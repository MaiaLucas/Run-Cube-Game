...
-- Show the cube
local cube = display.newImageRect("images/cube.png", 60, 60)
...
local function createObstacles()
    ...
    if ( whereFrom == 1 ) then
        -- From the bottom
        local newObstacle = display.newImageRect("images/obstacle-1.png", 90, 100 )
    ...
    elseif( whereFrom == 2 ) then
        local obstacle2 = graphics.newImageSheet( "images/obstacle-2.png", sheetOptions )
